...
class CategoryGifts extends StatefulWidget {
  String tabAgeGroupIndexSelected;
  CategoryGifts({this.tabAgeGroupIndexSelected});

  @override
  _CategoryGiftsState createState() => _CategoryGiftsState(tabAgeGroupIndexSelected);
}

class _CategoryGiftsState extends State<CategoryGifts> {
  String tabAgeGroupIndexSelected;
   _CategoryGiftsState(this.tabAgeGroupIndexSelected);
