...
class OccasionGifts extends StatefulWidget {
    String tabOccasionIndexSelected;
  OccasionGifts({this.tabOccasionIndexSelected});

  @override
  _OccasionGiftsState createState() => _OccasionGiftsState(tabOccasionIndexSelected);
}

class _OccasionGiftsState extends State<OccasionGifts> {
   String tabOccasionIndexSelected;
   _OccasionGiftsState(this.tabOccasionIndexSelected);
  ...
  Future getData() async {
    ...
    http.Response response = await http.get(
      Uri.parse('http://10.0.2.2:8000/ageGroup/$tabOccasionIndexSelected'),
      headers: {
